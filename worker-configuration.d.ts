/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 64fd00c7dafac92b251851b02a0c8f18)
// Runtime types generated with workerd@1.20251210.0 2025-05-06 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Sandbox" | "SandboxLock";
	}
	interface Env {
		REELLOLY_BUCKET_NAME: "reeloly";
		ENVIRONMENT: "dev";
		AGENT_REPO_URL: "https://github.com/reeloly/reeloly-agent.git";
		ALLOWED_ORIGINS: ["http://localhost:3000","https://reeloly.com"];
		ANTHROPIC_API_KEY: string;
		CLERK_PUBLISHABLE_KEY: string;
		CLERK_SECRET_KEY: string;
		CLOUDFLARE_ACCOUNT_ID: string;
		REELLOLY_BUCKET_ACCESS_KEY_ID: string;
		REELLOLY_BUCKET_SECRET_ACCESS_KEY: string;
		E2B_API_KEY: string;
		Sandbox: DurableObjectNamespace<import("./src/index").Sandbox>;
		SandboxLock: DurableObjectNamespace<import("./src/index").SandboxLock>;
		REELLOLY_BUCKET: R2Bucket;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REELLOLY_BUCKET_NAME" | "ENVIRONMENT" | "AGENT_REPO_URL" | "ALLOWED_ORIGINS" | "ANTHROPIC_API_KEY" | "CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "REELLOLY_BUCKET_ACCESS_KEY_ID" | "REELLOLY_BUCKET_SECRET_ACCESS_KEY" | "E2B_API_KEY">> {}
}
